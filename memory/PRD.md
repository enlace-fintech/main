...
- Banner cripto sin plazo "24–48 h" (usuario, 2026-06-11).
- Cripto (2026-06-11): renombrado a "Cobros y pagos cripto" (menú, hub, footer, breadcrumb, seo). FlexPei = "Integrador de activos digitales" (NUNCA "exchange"/"intercambio"); FluxiPay = "Integrador para cobros cripto en e-commerce". Ilustraciones: cripto-flexpei, cripto-fluxipay (tarjetas de aliados), cripto-flujo (banner "Cripto → pesos"), cripto-internacional (¿Por qué elegirnos?).
- Consultoría empresarial ampliada (2026-06-11): imagen por área (public/img/cons-*.webp, 6) con crossfade en el panel de tabs; bloque "¿Cuál es tu situación?" (6 casos que saltan al tab correspondiente, #consultoria-areas); proceso en 4 pasos (CONSULTORIA.proceso); audience chips; FAQ (4) + CTA vía SectorExtras; FAQPage JSON-LD en seo.js.
- Plan Platinum (2026-06-11): 5º plan "Servicios premium personalizados", sin precio ("A cotizar"), flag `contact: true`; coberturas ampliadas (GMM internacional, vida/accidentes a la medida, auto y hogar, concierge médico). CTA del cotizador cambia a "Contactar para plan Platinum" con mensaje propio. Imagen public/img/plan-platinum.webp.
...
- P1: Reemplazar datos de contacto placeholder restantes (dirección real, redes, teléfonos de Guadalajara/Monterrey). Teléfono y WhatsApp REALES ya configurados: +52 56 7125 8244 (BRAND.phone/whatsapp, 2026-06-11).
