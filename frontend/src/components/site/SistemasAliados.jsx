        ...
        {compact ? (
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <Reveal delay={0.12} className="relative">
              ...
              <img src={SISTEMAS.image} alt={SISTEMAS.title} className="relative rounded-2xl border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.5)] w-full h-[420px] object-cover" />
            </Reveal>
          </div>
        )}
