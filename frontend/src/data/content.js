...
export const NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Calculadora de ahorro TPV", href: "/calculadora-tpv" },
  ...
  { label: "Por qué Enlace", href: "/por-que-enlace" },
...
export const PERSONA = {
  ...
  image: "/img/persona-hero.webp",
  points: [
    { image: "/img/persona-p-0.webp", icon: "CreditCard", title: "Tarjeta física y virtual", text: "Tarjeta nominativa física y virtual, sin anualidad." },
    { image: "/img/persona-p-1.webp", icon: "Banknote", title: "Nómina y SPEI 24/7", text: "Recibe tu nómina y transferencias SPEI 24/7 con FlexPei." },
    { image: "/img/persona-p-2.webp", icon: "Receipt", title: "Paga lo de todos los días", text: "Paga servicios, suscripciones y compras en línea." },
    { image: "/img/persona-p-3.webp", icon: "Store", title: "Retira y deposita", text: "Retira en cajeros y deposita en tiendas de autoservicio." },
    { image: "/img/persona-p-4.webp", icon: "Nfc", title: "Acepta en todo el mundo", text: "Chip, banda magnética y contactless con aceptación nacional e internacional." },
    { image: "/img/persona-p-5.webp", icon: "HeartHandshake", title: "Beneficios incluidos", text: "Accede a beneficios: seguros, gimnasios, asistencias y descuentos." },
  ],
};
...
export const MEMBRESIAS = {
  ...
  plans: [
    ...
    { key: "platinum", image: "/img/plan-platinum.webp", name: "Platinum", tag: "Servicios premium personalizados", contact: true, priceLabel: "A cotizar", period: "según coberturas", desc: "Programa a la medida para directivos, socios y puestos clave, con las coberturas de seguros más amplias.", features: ["Todo lo de Black", "Gastos médicos mayores con suma asegurada ampliada y cobertura internacional", "Seguro de vida y accidentes con sumas a la medida", "Seguro de auto y hogar para el titular", "Asistencias premium: concierge médico, segunda opinión y traslados", "Diseño del paquete con tu equipo de RH y ejecutivo dedicado"] },
  ],
  sizes: [
    { label: "1-5", min: 1 },
    { label: "5-10", min: 5 },
...
export const TPV = {
  ...
  benefits: [
    { image: "/img/tpv-b-0.webp", title: "Reportes en tiempo real", text: "Reportes de cobros por terminal, en tiempo real, desde una plataforma en línea." },
    { image: "/img/tpv-b-1.webp", title: "Sin trámites bancarios", text: "Sin trámites bancarios ni requisitos complejos para obtener tus terminales." },
    { image: "/img/tpv-b-2.webp", title: "Sin mínimos de operación", text: "Sin mínimos de operación para otorgarte la terminal." },
    { image: "/img/tpv-b-3.webp", title: "Nunca dejes de cobrar", text: "No pierdes ventas por fallas de una sola terminal." },
    { image: "/img/tpv-b-4.webp", title: "Operación blindada", text: "Blindamos tu operación." },
    { image: "/img/tpv-b-5.webp", title: "Las terminales que necesitas", text: "Asignamos la cantidad de terminales que tu negocio necesita." },
    { image: "/img/tpv-b-6.webp", title: "Certeza legal", text: "Certeza legal y tranquilidad financiera con un contrato de administración de tesorería." },
    { image: "/img/tpv-b-7.webp", title: "Liquidación flexible", text: "Opciones variadas de liquidación de tus cobros." },
    { image: "/img/tpv-b-8.webp", title: "Cortes a tu medida", text: "Fechas de corte personalizadas para tu negocio." },
    { image: "/img/tpv-b-9.webp", title: "Únicas o alternas", text: "Úsalas como terminales únicas o alternas en tu negocio." },
  ],
  premium: {
